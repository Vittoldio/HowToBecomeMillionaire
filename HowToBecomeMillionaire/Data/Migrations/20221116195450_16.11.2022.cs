...
{
    public partial class _16112022 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BestResult", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BestResult_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BestResult_GameModes_GameModeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BestResult_GameModeId",
                table: "BestResult",
                column: "GameModeId");

            migrationBuilder.CreateIndex(
                name: "IX_BestResult_UserId",
                table: "BestResult",
                column: "UserId");
        }
